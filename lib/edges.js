...
function _intersectionsWithSpecialPoints(edge1, edge2, specialPoints1, specialPoints2, iterations) {
...
export function intersections(edge1, edge2, iterations) {
  ...
  const res = _intersectionsWithSpecialPoints(
    edge1, edge2, edge1.extremePoints(), edge2.extremePoints(), iterations
  );
  if (res === undefined) {
    return undefined;
  }
